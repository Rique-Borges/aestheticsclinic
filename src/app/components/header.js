      ...
      <AnimatePresence>
        {menuOpen && (
          <motion.div
            ...
            className="absolute top-16 left-0 w-full bg-white shadow-md md:hidden flex flex-col space-y-4 p-6 items-start"
          >
            <Link href="/#treatments" className="text-gray-700 hover:text-[#8ED1FB] transition">
              Treatments
            </Link>
            ...
            <button className="bg-[#6FC4FA] text-white py-2 px-6 rounded-3xl hover:bg-[#8ED1FB] transition mt-4 w-full">
              Book an Appointment
            </button>
          </motion.div>
        )}
